...
<div class="container mt-5">
    ...
    <div class="row mt-4">
        ...
        <!-- Tables Column -->
        <div class="col-md-8">
            <!-- Voitures Disponibles Table -->
            <h2>Voitures disponibles pour location</h2>
            <table class="table">
                <thead>
                    <tr>
                        <th>Reg_num</th>
                ...
                <tbody>
                    ...
                    for (Location location : locationsList) { %>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning" onclick="populateForm('<%= location.getNumReg() %>','<%= location.getCustomerName() %>','<%= location.getStartDate() %>','<%= location.getEndDate() %>','<%= location.getRentFee() %>')">Modifier</button>
